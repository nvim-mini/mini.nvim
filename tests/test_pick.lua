...
T['setup()']['creates `config` field'] = function()
  ...
  expect_config('mappings.scroll_preview_down', '<M-f>')
  expect_config('mappings.scroll_preview_left', '<M-h>')
  expect_config('mappings.scroll_preview_right', '<M-l>')
  expect_config('mappings.scroll_preview_up', '<M-b>')
...
T['setup()']['validates `config` argument'] = function()
  ...
  expect_config_error({ mappings = { scroll_preview_down = 1 } }, 'mappings.scroll_preview_down', 'string')
  expect_config_error({ mappings = { scroll_preview_left = 1 } }, 'mappings.scroll_preview_left', 'string')
  expect_config_error({ mappings = { scroll_preview_right = 1 } }, 'mappings.scroll_preview_right', 'string')
  expect_config_error({ mappings = { scroll_preview_up = 1 } }, 'mappings.scroll_preview_up', 'string')
